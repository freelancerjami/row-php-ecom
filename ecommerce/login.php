	...
	<section id="content">
		<div class="content-blog">
			<div class="container">
				...
				<?php if(isset($_GET['massages'])){
						if ( $_GET['massages']==1) {?>
                    <p class=" alert alert-success" role="alert" ><?php echo "Invalid login Credentials."; ?></p>
               <?php }}?>
							<div class="row">
				...
				<div class="col-md-6">
					<div class="box-content">
						...
						<div class="clearfix space40"></div>
						<form class="logregform" method="post" action="registrationprocess.php">
					
					<?php if(isset($_GET['massages'])){
						if ( $_GET['massages']==2) {?>
                    <p class=" alert alert-success" role="alert" ><?php echo "Falid to register."; ?></p>
               <?php }}?>
